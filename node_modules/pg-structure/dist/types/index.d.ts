...
export declare type TriggerOrientation = "row" | "statement";
/** Time at which the trigger fires */
export declare type TriggerTiming = "before" | "after" | "insteadOf";
/** Event that fires the trigger */
export declare type TriggerEvent = "insert" | "delete" | "update" | "truncate";
/** In which session_replication_role modes the trigger fires. */
export declare type TriggerEnabled = "origin" | "disabled" | "replica" | "always";
/**
